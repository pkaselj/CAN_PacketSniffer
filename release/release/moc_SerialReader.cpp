...
QT_MOC_LITERAL(3, 27, 7), // "RawData"
QT_MOC_LITERAL(4, 35, 10), // "tableEntry"
QT_MOC_LITERAL(5, 46, 13), // "StopExecution"
QT_MOC_LITERAL(6, 60, 19), // "ConnectToSerialPort"
QT_MOC_LITERAL(7, 80, 24), // "SerialPortConnectionInfo"
QT_MOC_LITERAL(8, 105, 14), // "connectionInfo"
QT_MOC_LITERAL(9, 120, 17) // "DataReadyToBeRead"

    },
    "SerialReader\0DataReceived\0\0RawData\0"
    "tableEntry\0StopExecution\0ConnectToSerialPort\0"
    "SerialPortConnectionInfo\0connectionInfo\0"
    "DataReadyToBeRead"
};
...
void SerialReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->DataReceived((*reinterpret_cast< RawData(*)>(_a[1]))); break;
        case 1: _t->StopExecution(); break;
        case 2: _t->ConnectToSerialPort((*reinterpret_cast< SerialPortConnectionInfo(*)>(_a[1]))); break;
        case 3: _t->DataReadyToBeRead(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SerialReader::*)(RawData );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialReader::DataReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SerialReader::DataReceived(RawData _t1)
{
